...
namespace Diva.Comms
{
	public class SerialPort : System.IO.Ports.SerialPort, ICommsSerial
	{
		...
		public new bool DtrEnable { get { return base.DtrEnable; } set { log.Info(base.PortName + " DtrEnable " + value); if (base.DtrEnable == value) return; base.DtrEnable = value; } }
		public new bool RtsEnable { get { return base.RtsEnable; } set { log.Info(base.PortName + " RtsEnable " + value); if (base.RtsEnable == value) return; base.RtsEnable = value; } }
