    ...
    public partial class Planner : UserControl
    {
        ...
        private void Commands_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.ColumnIndex == colPrev.Index && e.RowIndex != 0) // up
                {
                ...
                if (e.ColumnIndex == colNext.Index && e.RowIndex < DGVWayPoints.RowCount - 1) // down
                {
                    DataGridViewRow myrow = DGVWayPoints.CurrentRow;
                    DGVWayPoints.Rows.Remove(myrow);
                    DGVWayPoints.Rows.Insert(e.RowIndex + 1, myrow);
        ...
        public void BUT_Live_Click(object sender, EventArgs e)
        {
            var dsettings = ConfigData.GetTypeList<DroneSetting>().Where(d => d.Checked);
