...
{
    public partial class DialogOrigin : Form
    {
        ...
        {
            int xCenter = (this.panelButtons.Width - btnClose.Width) / 2;
            int yCenter = (this.panelButtons.Height - btnClose.Height) / 2;
            ...
            switch (buttons)
            {
                case MessageBoxButtons.OK:
                    ...
                    btnClose.Location = new Point(xCenter, yCenter);
                    btnClose.Text = "Ok";
                    btnClose.DialogResult = DialogResult.OK;//Set DialogResult
                ...
                case MessageBoxButtons.OKCancel:
                    //OK Button
                    btnClose.Visible = true;
                    btnClose.Location = new Point(xCenter - (btnClose.Width / 2) - 5, yCenter);
                    btnClose.Text = "Ok";
                    btnClose.DialogResult = DialogResult.OK;//Set DialogResult
                ...
                case MessageBoxButtons.RetryCancel:
                    ...
                    btnClose.Location = new Point(xCenter - (btnClose.Width / 2) - 5, yCenter);
                    btnClose.Text = "Retry";
                    btnClose.DialogResult = DialogResult.Retry;//Set DialogResult
                ...
                case MessageBoxButtons.YesNo:
                    ...
                    btnClose.Location = new Point(xCenter - (btnClose.Width / 2) - 5, yCenter);
                    btnClose.Text = "Yes";
                    btnClose.DialogResult = DialogResult.Yes;//Set DialogResult
                ...
                case MessageBoxButtons.YesNoCancel:
                    //Yes Button
                    btnClose.Visible = true;
                    btnClose.Location = new Point(xCenter - btnClose.Width - 5, yCenter);
                    btnClose.Text = "Yes";
                    btnClose.DialogResult = DialogResult.Yes;//Set DialogResult
                ...
                case MessageBoxButtons.AbortRetryIgnore:
                    ...
                    btnClose.Location = new Point(xCenter - btnClose.Width - 5, yCenter);
                    btnClose.Text = "Abort";
                    btnClose.DialogResult = DialogResult.Abort;//Set DialogResult
        ...
        private void SetDefaultButton(MessageBoxDefaultButton defaultButton)
        {
            switch (defaultButton)
            {
                case MessageBoxDefaultButton.Button1://Focus button 1
                    ...
                    btnClose.Font = new Font(btnClose.Font, FontStyle.Underline);
                    break;
